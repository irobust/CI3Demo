...
class MY_Pagination extends CI_Pagination{
	...
	protected $constant_num_links = TRUE;
	...
	function __construct(){
		...
		// 	$this->CI->lang->load('pagination', $_SESSION['lang']);
		// }else{
			// $this->CI->lang->line('pagination_first_link');
		// }
	}
	...
	public function append($var){
		...
		// $this->base_url = $this->CI->config->site_url($this->CI->uri->uri_string()).$tail;
	}
	...
	public function create_links(){
		...
		// Add by Phanupong Permpimol
		// Change To Static number of links
